...
import {getListOfPokemons, getPokemonDetails} from "../redux/sagaSlice";
import {Ability, Moves, BasicDetails} from "../screens/Pokemonthings/DetailsPokemon";
...
function* fetchPokemonList(){
    try{
        ...
        //console.log("fetchListOfPokemons");
